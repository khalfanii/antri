...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard');?>">Kelompok 2</a>
</div>
<ul class="nav navbar-right top-nav">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li>
                <a href="<?php echo base_url('admin/login/logout');?>"><i class="fa fa-fw fa-power-off"></i> Keluar</a>
            </li>
        </ul>
    </li>
</ul>
