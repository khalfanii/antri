...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Antrian klinik</a>
  ...
  <header class="masthead bg-info text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0"><img class="masthead-avatar mb-5" src="<?php echo base_url('assets/user') ?>/img/bg2.png" alt="">klinik</h1>
      <div class="row">
      ...
      <?php } ?>
      <?php if(empty($this->session->userdata('id_pasien'))){ ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di klink sehat. 
          ...
          <div class="container">
            <div class="row justify-content-md-center">
              <div class="col-md-4" style="margin-top: 20px">
                ...
                <br><center><p>Made with <a href='https://instagram.com/rozatarina_08?igshid=M2RkZGJiMzhjOQ==' title='StokCoding.com' target='_blank'>Kelompok 2</a></p></center>
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-12" style="margin-top: 20px">
                ...
                <form action="<?php echo base_url('Index/saveAntrian') ?>" method="post">
                  ...
                  <div class ="row">
                    <div class ="col-md-2">
                      <h6><label>No Antrian anda</label></h6>    
                    </div>
    ...
    <div class="container">  
      <div class="row">
        <div class="col-lg-4.ml-auto" align="center" >
          <p class="lead">Klik Login Lalu Pilih Poli Setelah itu Klik Cetak</p>
          <p class="lead">Pasien melakukan Registrasi Dan Menginputkan Nomor Identitas, Nama Pasien, Jenis Kelamin, Usia, Tanggal Lahir, Alamat, Nomor Telephone, Username dan Password</p>
      </div>
    </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">di Jalan Batam, Lantai II Gedung Teknik Informatika,
            <br>Lhokseumawe</p>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <p class="lead mb-0">+62 852-6009-7215</p>
          <p class="lead mb-0">+62 812-6996-3591</p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy; Klinik Sehat 2020 Made ByKelompok 2 </small>
    </div>
  </section>
