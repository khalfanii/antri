...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container" style="margin-top: 0px;">
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?php echo base_url('assets/user')?>/img/logo.png" alt=""  width="50">Antrian Klinik</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    ...
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Klinik Sehat. 
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy; Klinik Sehat 2019 Made By Roza Tarina </small>
    </div>
  </section>
